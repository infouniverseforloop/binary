/* computeStrategy.js — confluence engine (multi-TF heuristics + candle size tag) */
...
// new: candle size classification
...
function computeSignalForSymbol(symbol, barsRef, opts = {}){
  ...
  // multi-TF confluence: check m15 trend
  ...
  // compute avg body for last N bars for candle size classification
